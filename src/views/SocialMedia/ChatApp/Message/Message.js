...
import { setfavouriteChannel, removefavouriteChannel } from "../../../../Action/ActionCreater";
...
const mapStateToProps = (state) => {
    return {
        channel: state.channel && state.channel.currentChannel,
        user:state.user && state.user.currentUser,
        favouriteChannels:state.favouriteChannel && state.favouriteChannel.favouriteChannel
    }
}
